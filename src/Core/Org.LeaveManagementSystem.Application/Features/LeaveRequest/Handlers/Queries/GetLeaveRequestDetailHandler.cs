...
using Org.LeaveManagementSystem.Application.Features.LeaveRequest.Requests.Queries;
...
namespace Org.LeaveManagementSystem.Application.Features.LeaveRequest.Handlers.Queries
{
